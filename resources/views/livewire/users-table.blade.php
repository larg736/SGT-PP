<div>
    <h2 class="mb-2 text-lg font-medium text-gray-800 dark:text-white">USUARIO</h2>
        ...
        <div class="flex flex-col items-center justify-between p-4 space-y-3 md:flex-row md:space-y-0 md:space-x-4">
            ...
            <div class="flex flex-col items-stretch justify-end flex-shrink-0 w-full space-y-2 md:w-auto md:flex-row md:space-y-0 md:items-center md:space-x-3">
                ...
                <div class="flex items-center w-full space-x-3 md:w-auto">
                    ...
                    <a href="{{ route('users.create') }}" class="py-2.5 px-5 text-sm font-medium text-gray-900 focus:outline-none bg-white rounded-lg border border-gray-200 hover:bg-gray-100 dark:bg-gray-900 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-900 transform hover:scale-110" title="Agregar Usuario">
                        Agregar
                    </a>

                    <a href="/usersprint" class="btnprn text-white text-sm py-2.5 px-5 bg-white rounded-lg border border-gray-200 hover:bg-gray-100 dark:bg-gray-900 dark:text-gray-400 dark:border-gray-600 dark:hover:text-white dark:hover:bg-gray-900 transform hover:scale-110" title="Imprimir">
                ...
                <div class="overflow-hidden border border-gray-200 dark:border-gray-700 md:rounded-lg">
                    <table class="min-w-full divide-y divide-gray-200 dark:divide-gray-700" id="myTable">
                        <thead>
                            ...
                            <th class="px-4 py-3">
                                <div class="flex items-center">
                                    <button wire:click="orderBy('email')">EMAIL</button>
                                    <x-order-icon sortField="email" :order-by="$orderBy" :order-asc="$orderAsc"/>
                                </div>
                            </th>
                            ...
                            <tr class="text-gray-700">
                                ...
                                <td class="px-4 py-3 text-sm">
                                    <div class="flex item-center justify-center">
                                        @if ($user->trashed())
                                            <a href="/users/{{ $user->id }}/restore" class="w-4 mr-2 transform hover:scale-110" title="Restaurar">
                                        ...
                                        @else
                                            <a href="{{ route('users.edit', $user->id) }}" class="w-4 mr-2 transform hover:scale-110" title="Editar">
                                            ...
                                            <button type="submit" class="w-4 mr-2 transform hover:scale-110" title="Eliminar" wire:click="$emit('deleteuser', {{$user->id}})">
    ...
    <script>
        ...
        Swal.fire({
            ...
            if (result.isConfirmed) {
                ...
                Livewire.emitTo('users-table', 'destroy', userId);
