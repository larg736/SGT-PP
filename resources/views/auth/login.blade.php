<x-guest-layout>
    ...
    <section class="bg-gray-900 bg-opacity-60">
        <div class="flex flex-col items-center justify-center px-6 py-8 mx-auto md:h-screen lg:py-0">
            <a href="/" class="flex items-center mb-6 text-2xl font-semibold text-gray-900 dark:text-white">
                <img class="w-12 h-12 mr-2" src="https://ronalca.com/wp-content/uploads/2019/11/Logo-UNEG.png" alt="logo">
                Gestión de Tareas    
            </a>
            <div class="w-full bg-white rounded-lg shadow dark:border md:mt-0 sm:max-w-md xl:p-0 dark:bg-gray-800 dark:border-gray-700">
                <div class="p-6 space-y-4 md:space-y-6 sm:p-8">
                    ...
                    <form class="space-y-4 md:space-y-6" method="POST" action="{{ route('login') }}">
                        ...
                        <x-button-alternative class="w-full font-medium rounded-lg px-5 py-2.5">
                            {{ __('Log in') }}
