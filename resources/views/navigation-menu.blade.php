<nav x-data="{ open: false }" class="bg-gray bg-gray-900 bg-opacity-90">
        ...
        <div class="flex justify-between h-16">
            <div class="flex">
                ...
                <div class="hidden space-x-8 sm:-my-px sm:ml-10 sm:flex">
                    <div class="mt-4">
                        <select id="list-of-departments" class="bg-gray-700 text-gray-400 rounded-md px-10 py-2 text-sm font-medium" required>
                    ...
                    <x-nav-link href="{{ route('demands.index') }}" :active="request()->routeIs('dashboard')">
                        {{ __('Tareas') }}
                    </x-nav-link>
    ...
    <div :class="{'block': open, 'hidden': ! open}" class="hidden sm:hidden">
        <div class="pt-2 pb-3 space-y-1">
            @if (auth()->user()->is_admin)
            <x-responsive-nav-link href="{{ route('demands.index') }}" :active="request()->routeIs('dashboard')">
                {{ __('Tareas') }}
            </x-responsive-nav-link>
            <x-responsive-nav-link href="{{ route('departments.index') }}" :active="request()->routeIs('dashboard')">
                {{ __('Departamento') }}
            </x-responsive-nav-link>
