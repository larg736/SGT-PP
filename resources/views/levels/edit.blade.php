            ...
            <form method="post" action="{{ route('levels.update', $level->id) }}">
                ...
                <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 lg:grid-cols-3">
                    <div class="text-gray-100">
                        <p class="font-medium text-lg">Editar Level</p>
                        <p>....</p>
                    </div>
                    <div class="lg:col-span-2">
                        ...
                        value="{{ old('department_id',$level->department_id ) }}" required/>

                        <div class="grid gap-4 gap-y-2 text-sm grid-cols-1 md:grid-cols-4">
                            <div class="md:col-span-2">
                                <div class="md:col-span-2">
                                    <x-gray-label for="name" value="{{ __('Nombre') }}" />
                                    <x-gray-input id="name" class="block mt-1 w-full" type="text" name="name" :value="$level->name" minlength="5" maxlength="20" autofocus required autocomplete="name" />
                                </div>
                            </div>
